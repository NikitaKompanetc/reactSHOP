...
class LinkExisting extends PureComponent {
  ...
  getPrinsterProduct = () => {
    Api.get(`https://a8ed81e6da8c.ngrok.io/api/linkedProducts/`, { headers: { 'x-auth-token': `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KbP1-46OB4Flq4o9fNLP6ncBXnlP1AXBaamiOLjMAqw` } })
      .then((data) => {
        this.setState({
  ...
  // }
  getShopifyProducts = () => {
    Api.get(`https://a8ed81e6da8c.ngrok.io/api/shopify/products`, { headers: { 'x-auth-token': `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KbP1-46OB4Flq4o9fNLP6ncBXnlP1AXBaamiOLjMAqw` } })
      .then((data) => {
        this.setState({
          productPrinsterArr: data
        })
