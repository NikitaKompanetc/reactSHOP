...
const SalesReport = ({ t }) => (
  <Panel md={12} lg={7} xl={5} sm={12} xs={12} title={t('dashboard_commerce.sales_report')}>
    <div className="dashboard__sales-report">
      <div className="progress-wrap progress-wrap--small progress-wrap--orange">
        ...
        <Progress value={100} style={{ backgroundColor: '#e78624' }} />
      </div>
      <div className="progress-wrap progress-wrap--small progress-wrap--red">
        ...
        <Progress value={98} style={{ backgroundColor: '#e78624' }} />
      </div>
      <div className="progress-wrap progress-wrap--small progress-wrap--pink">
        ...
        <p className="dashboard__sales-report-value progress__label">87%</p>
        <Progress value={87} style={{ backgroundColor: '#e78624' }} />
      </div>
    </div>
  </Panel>
);
