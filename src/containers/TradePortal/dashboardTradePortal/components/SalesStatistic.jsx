...
const data01 = [{ value: 80, fill: '#C4C41E' },
{ value: 20, fill: '#eeeeee' }];

const data02 = [{ value: 50, fill: '#E35030' },
  ...
  >
    <div className="dashboard__stat">
      <div className="dashboard__stat-chart">
        ...
        <p className="dashboard__stat-label" style={{ color: '#C4C41E' }}>80%</p>
      </div>
    ...
    <div className="dashboard__stat">
      <div className="dashboard__stat-chart">
        ...
        <p className="dashboard__stat-label" style={{ color: '#E35030' }}>50%</p>
      </div>
      <div className="dashboard__stat-info">
        <p>Top selling items statistic by last month</p>
        <h4 className="dashboard__stat-number">
